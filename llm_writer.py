...
1. **종결어미 (모든 섹션 동일 적용 — VI. 평가 포함)**: "~임", "~하였음", "~요인임", "~확인함", "~의미를 둠", "~판단됨" 등 실무 보고서 투 사용. ⚠️ **평가(VI.) 섹션에서도 절대 "~니다/~습니다" 사용 금지**. 입력 인사이트가 "~니다"로 끝나면 모두 "~임/~함"으로 변환: "높았습니다"→"높음", "기록했습니다"→"기록함", "필요합니다"→"필요함", "이루어졌습니다"→"이루어짐", "달성했습니다"→"달성함". "~이다", "~분석된다" 같은 학술적 종결도 금지

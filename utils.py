...
def collect_analysis_data() -> dict:
    ...
    return {
        ...
        "총 사용 예산": (s.budget_exhibition + s.budget_supplementary) or None,
        "전시 사용 예산": s.budget_exhibition or None,
        "부대 사용 예산": s.budget_supplementary or None,
        "예산 계획액": s.budget_planned or None,
        "총수입": (s.ticket_revenue + s.get("other_revenue", 0)) or None,
        ...
        "출품 작품 수_총": (s.artwork_painting + s.artwork_sculpture + s.artwork_photo + s.artwork_installation + s.artwork_media + s.artwork_other) or None,
